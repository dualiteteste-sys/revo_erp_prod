/*
  ...
  - REVOKE/GRANT restritos; logs leves via pg_notify.
  - RLS: função de sistema executa sob definer.
...
begin
  ...
  -- Cria empresa padrão (campos corretos!)
  ...
  -- Vincula usuário como OWNER (idempotente)
  if not exists (
