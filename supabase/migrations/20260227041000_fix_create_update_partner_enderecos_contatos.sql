-- [RPC FIX] create_update_partner — keep inserted enderecos/contatos
-- Context: the function was inserting new rows but not tracking their IDs in v_endereco_ids/v_contato_ids,
-- causing the "replace set semantics" delete step to remove everything right after insert.
