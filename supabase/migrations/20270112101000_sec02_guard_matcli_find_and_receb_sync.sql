/*
  SEC-02/RG-03: Guard de permissão em RPCs SECURITY DEFINER (novas/atualizadas)

  O pipeline valida que RPCs SECURITY DEFINER usadas pelo app chamem:
  - require_permission_for_current_user(...)

  Este arquivo adiciona o guard nas funções:
  - industria_materiais_cliente_find_id (read)
  - recebimento_sync_materiais_cliente (update)
*/

begin;

-- -----------------------------------------------------------------------------
-- 1) Indústria: lookup Material do Cliente (read)
-- -----------------------------------------------------------------------------
...
begin
  ...
  perform public.require_permission_for_current_user('industria','view');
...
-- -----------------------------------------------------------------------------
-- 2) Suprimentos: sync Materiais do Cliente (update)
-- -----------------------------------------------------------------------------
