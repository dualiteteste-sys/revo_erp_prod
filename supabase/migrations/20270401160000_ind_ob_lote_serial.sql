-- =============================================================================
-- feat: Lote e Número de Série na Ordem de Beneficiamento
-- - Adiciona colunas lote e numero_serie em industria_ordens
-- - Atualiza industria_upsert_ordem para persistir os novos campos
-- - Atualiza industria_clone_ordem para copiar os novos campos
-- =============================================================================
BEGIN;
...
-- 2) Atualiza RPC industria_upsert_ordem (__unsafe + wrapper)
...
BEGIN
  IF p_payload->>'id' IS NOT NULL THEN
    ...
    SET
      ...
      lote                       = COALESCE(p_payload->>'lote', lote),
      numero_serie               = COALESCE(p_payload->>'numero_serie', numero_serie),
...
-- 3) Atualiza industria_clone_ordem para copiar lote e numero_serie
