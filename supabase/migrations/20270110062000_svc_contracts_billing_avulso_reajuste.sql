-- ============================================================================
-- Serviços / Contratos (MVP4): Itens avulsos + reajuste manual (recalcular futuro)
-- ============================================================================
--
-- Objetivo:
-- - Permitir lançar cobranças avulsas no schedule (kind='avulso')
-- - Permitir reajuste simples: ao alterar valor mensal, recalcular linhas futuras
--   do schedule mensal (status='previsto', sem título) para refletir a regra atual.
...
-- Ajusta descrição na geração de títulos (usa schedule.descricao quando avulso)
