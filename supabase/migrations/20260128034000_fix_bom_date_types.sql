...
REVOKE ALL ON FUNCTION public.industria_bom_list(text, uuid, text, boolean, int, int) FROM public;
GRANT EXECUTE ON FUNCTION public.industria_bom_list(text, uuid, text, boolean, int, int)
