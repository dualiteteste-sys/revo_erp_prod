/*
  Fix: fiscal_nfe_emissoes_list referencia e.danfe_url / e.xml_url,
  mas essas colunas estão em fiscal_nfe_nfeio_emissoes (tabela separada).
  O JOIN foi perdido na migration 20270315200000.

  Fix: restaurar LEFT JOIN fiscal_nfe_nfeio_emissoes e usar nio.danfe_url / nio.xml_url.
*/
