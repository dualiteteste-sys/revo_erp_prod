-- Fix: Fluxo de Caixa — incluir títulos a receber com status 'parcial' no previsto
-- Problema: a migration 20270206 adicionou o status 'parcial' ao enum status_conta_receber,
-- mas a RPC financeiro_fluxo_caixa_centered nunca foi atualizada para incluí-lo.
-- Resultado: títulos com pagamento parcial eram ignorados na projeção de receitas previstas.
  ...
  titulos_receber_previsto as (
    ...
    where c.empresa_id = v_empresa
      and c.status in (
        ...
        'vencido'::public.status_conta_receber,
        'parcial'::public.status_conta_receber
      )
