/*
  # Fix: restaurar vendedor_id em vendas_upsert_pedido

  ## Descrição
  A migration 20270313230000 reescreveu vendas_upsert_pedido sem incluir
  vendedor_id e comissao_percent (regressão). Este fix restaura ambos campos.

  ## Impact Summary
  - Idempotente: CREATE OR REPLACE
  - Sem breaking changes: campos são opcionais (nullif)
*/
...
DECLARE
  ...
  v_comissao  numeric := (p_payload->>'comissao_percent')::numeric;
BEGIN
