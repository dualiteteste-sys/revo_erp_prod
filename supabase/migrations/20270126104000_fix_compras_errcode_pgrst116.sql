-- =============================================================================
-- FIX: Compras (OC) - substituir errcode inválido 'PGRST116' (não é SQLSTATE)
-- Motivo: PostgreSQL exige SQLSTATE (5 chars) em USING errcode. 'PGRST116' quebra
--         a RPC com: unrecognized exception condition "PGRST116" (42704).
-- Estratégia: usar SQLSTATE 'P0002' (no_data_found) para casos de "não encontrado".
-- =============================================================================

BEGIN;

-- Compras: get details (versão mais recente com campos de histórico)
