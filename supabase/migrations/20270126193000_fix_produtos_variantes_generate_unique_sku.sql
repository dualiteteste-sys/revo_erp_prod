-- Fix: produtos_variantes_generate_for_current_user deve ser idempotente e gerar SKU único
-- (evita 23505 em idx_produtos_empresa_sku_unique quando valores repetem, slug colide ou o usuário re-roda o wizard).
