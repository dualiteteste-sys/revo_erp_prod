/*
  Fase 7: Propagar numero_pedido_cliente e numero_item_pedido nos pedidos de venda
  - Atualizar vendas_upsert_pedido para aceitar numero_pedido_cliente
  - Atualizar vendas_upsert_item_pedido para aceitar numero_item_pedido
*/

-- Atualizar vendas_upsert_pedido para incluir numero_pedido_cliente
