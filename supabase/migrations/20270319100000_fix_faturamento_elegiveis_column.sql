-- Fix: industria_faturamento_listar_elegiveis referenciava e.documento_entrega
-- que não existe em industria_ordens_entregas (a coluna correta é documento_ref).
-- O coalesce era resquício da antiga tabela industria_benef_entregas.
