-- Fix: ecommerce_connections_disconnect was setting consumer_key_enc/consumer_secret_enc
-- to NULL, but the columns have NOT NULL constraints. Use empty string instead.
-- Ref: P1 incident 02/04/2026 — code 23502 on disconnect call.
...
REVOKE ALL ON FUNCTION public.ecommerce_connections_disconnect(uuid) FROM anon;
GRANT EXECUTE ON FUNCTION public.ecommerce_connections_disconnect(uuid) TO authenticated;
