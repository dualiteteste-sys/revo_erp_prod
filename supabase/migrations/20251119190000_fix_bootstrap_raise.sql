-- =============================================================================
-- Fix: Remove RAISE EXCEPTION from bootstrap_empresa_for_current_user
-- Motivo: User reported 'RAISE option already specified: MESSAGE' error (42601).
-- Ação: Replace RAISE with graceful return of error status.
-- =============================================================================
...
DECLARE
    ...
    v_user_meta  jsonb;
BEGIN
    -- Refactor: Avoid RAISE EXCEPTION
