...
## components/roadmap — 3 ocorrência(s)
...
## pages/fiscal — 3 ocorrência(s)

**Tabelas mais acessadas**
- `fiscal_nfe_emissao_itens`: 1
- `empresa_feature_flags`: 1
- `fiscal_nfe_emitente`: 1
...
## components/products — 1 ocorrência(s)
