...
export const HELP_CATALOG: HelpEntry[] = [
  ...
  },
  {
    ...
    title: 'Guia Rápido — Catálogo WooCommerce',
    whatIs:
      'Listagem completa de todos os produtos da loja WooCommerce com status de importação (Novo/Importado), busca, filtros e importação individual ou em massa para o ERP.',
    steps: [
      'Acesse via Produtos → “Catálogo Woo”. A listagem carrega automaticamente todos os produtos da loja.',
      'Use a busca para filtrar por nome ou SKU. Use os filtros “Todos”, “Novos” ou “Importados” para segmentar.',
      'Produtos com badge “Novo” ainda não existem no ERP — clique “Importar” para importar individualmente.',
      'Para importar vários: marque os checkboxes e clique “Importar N selecionados”. Revise o preview antes de confirmar.',
      'Produtos com badge “Importado” já existem no ERP — clique “Ver no ERP” para navegar ao cadastro.',
      'A importação é processada em segundo plano. A lista atualiza automaticamente após a conclusão.',
    ],
    dependsOn: ['Permissão: Produtos (view)', 'Loja WooCommerce cadastrada e com conexão ativa'],
    connectsWith: ['Produtos', 'Execução WooCommerce', 'Painel Dev WooCommerce', 'Integrações (Marketplaces)'],
    fillPerfectly: 'Cadastre os produtos com SKU no WooCommerce antes de importar. SKU é usado para vincular produtos e evitar duplicatas.',
    commonMistakes: ['Importar sem SKU definido no Woo — gera produtos sem vínculo.', 'Executar com blockers pendentes.', 'Não aguardar a conclusão do processamento antes de reimportar.'],
  },
  {
