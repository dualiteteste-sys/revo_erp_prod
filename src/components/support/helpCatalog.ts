...
export const HELP_CATALOG: HelpEntry[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Para dinheiro: informe o valor recebido e o troco será calculado automaticamente.',
      ...
      'Se NFC-e configurada (CSC): emitida automaticamente após a finalização.',
      'O comprovante exibe o DANFCE com chave de acesso quando autorizado. Use “DANFCE (PDF)” para baixar.',
      'Ao final do dia, encerre o caixa para ver o resumo por forma de pagamento.',
