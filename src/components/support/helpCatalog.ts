...
export const HELP_CATALOG: HelpEntry[] = [
...

  {
    ...
    fillPerfectly: [
      ...
      'Para produtos em KG: defina se aceita venda fracionada (ex.: 0,4 kg).',
  ...
  },
  {
    ...
    whatIs:
      'PDV é venda rápida com baixa de estoque, impacto no financeiro e emissão de NFC-e (cupom fiscal eletrônico). O foco é: velocidade com controle — sem “bagunçar o caixa”.',
    steps: [
      ...
      'Para produto em KG: alterne kg/g e digite (ex.: 400 g).',
      'Para atacado/varejo: ajuste quantidade e confirme preço automático.',
      'Clique “Finalizar” (F9) — o modal de pagamento abrirá.',
      'Escolha a forma de pagamento: Dinheiro, Pix, Cartão de Crédito, Cartão de Débito ou outra.',
      'Para pagamento em dinheiro: informe o valor recebido e o troco será calculado automaticamente.',
      'Para pagamento misto (split): clique “Adicionar forma de pagamento” e divida o valor (ex.: R$100 Pix + R$50 Dinheiro).',
      'Confirme o pagamento (F9) — a venda será finalizada (financeiro + estoque).',
      'Se a empresa tem NFC-e configurada (CSC): a NFC-e será emitida automaticamente após a finalização.',
      'O comprovante exibirá o DANFCE com chave de acesso quando a NFC-e for autorizada.',
      'Use o botão “DANFCE (PDF)” para baixar o documento fiscal oficial.',
      'Sem internet: finalize mesmo assim e aguarde a sincronização automática.',
    ],
    dependsOn: ['Conta corrente padrão (recebimentos)', 'Produtos com estoque (se aplicável)', 'Permissão: PDV (create)', 'CSC configurado (para NFC-e)'],
    connectsWith: ['Vendas (Pedidos)', 'Financeiro (Tesouraria)', 'Estoque (baixa e kardex)', 'Fiscal (NFC-e)', 'Condições de Pagamento'],
    fillPerfectly: [
    ...
    commonMistakes: [
      ...
      'Forma de pagamento incorreta: a NFC-e exige código SEFAZ correto (o sistema mapeia automaticamente).',
