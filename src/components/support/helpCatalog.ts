...
export const HELP_CATALOG: HelpEntry[] = [
  ...
  },
  {
    ...
    connectsWith: ['Vendas (Pedidos)', 'Financeiro (Tesouraria)', 'Estoque (baixa e kardex)', 'Condições de Pagamento (quando houver parcelas)'],
    fillPerfectly: [
  ...
  },
  {
    ...
    whatIs:
      'OP/OB organiza a produção/beneficiamento com estados travados e rastreabilidade. Para controle completo, “não pule etapas”. Para faturamento rápido, use o botão “Faturar” na OP a qualquer momento — produção completa NÃO é obrigatória.',
    steps: [
      ...
      'Para faturar: clique em “Faturar” na OP a qualquer momento — será criado um pedido + NF-e em rascunho para revisão.',
    ],
    ...
    commonMistakes: [
      ...
      'Achar que precisa concluir toda a produção para poder faturar — o botão “Faturar” funciona em qualquer status.',
    ],
    roadmapKey: 'industria',
  },
  {
