import {
  ...
  PackageCheck, FileUp, FolderTree, Ruler, BarChart3, Shield, ShieldCheck, ShieldAlert, Activity, Clock, CreditCard, Filter, Send
} from 'lucide-react';
...
export const menuConfig: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Propostas Comerciais', icon: FileSignature, href: '/app/vendas/propostas', permission: { domain: 'vendas', action: 'view' } },
      { name: 'PDV', icon: Store, href: '/app/vendas/pdv', permission: { domain: 'vendas', action: 'view' } },
      { name: 'Expedição', icon: Truck, href: '/app/vendas/expedicao', permission: { domain: 'vendas', action: 'view' } },
      { name: 'Comissões', icon: Percent, href: '/app/vendas/comissoes', permission: { domain: 'vendas', action: 'view' } },
      { name: 'Painel de Automações', icon: Bot, href: '/app/vendas/automacoes', permission: { domain: 'vendas', action: 'view' } },
      { name: 'Devolução de Venda', icon: Undo2, href: '/app/vendas/devolucoes', permission: { domain: 'vendas', action: 'view' } },
      { name: 'Relatórios', icon: BarChart2, href: '/app/vendas/relatorios', permission: { domain: 'vendas', action: 'view' } },
    ]
  },
  {
    name: 'Fiscal',
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Faturamento Mensal', icon: Send, href: '/app/servicos/faturamento-mensal', permission: { domain: 'servicos', action: 'view' } },
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Conciliação Cartão', icon: CreditCard, href: '/app/financeiro/conciliacao-cartao', permission: { domain: 'contas_a_pagar', action: 'view' } },
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Entitlements (Planos)', icon: ShieldAlert, href: '/app/desenvolvedor/entitlements', permission: { domain: 'ops', action: 'manage' } },
