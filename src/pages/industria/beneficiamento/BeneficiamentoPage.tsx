...
import { listOrdensBeneficiamento, OrdemBeneficiamento } from '@/services/industriaBeneficiamento';
import { PlusCircle, Search, LayoutGrid, List, Layers } from 'lucide-react';
  ...
  return (
    <div className="p-1 h-full flex flex-col">
      ...
      <Modal isOpen={isFormOpen} onClose={handleClose} title={selectedId ? 'Editar Ordem de Beneficiamento' : 'Nova Ordem de Beneficiamento'} size="6xl">
        <BeneficiamentoFormPanel ordemId={selectedId} onSaveSuccess={handleSuccess} onClose={handleClose} />
      </Modal>
    </div>
  );
}
