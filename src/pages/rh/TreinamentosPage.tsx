...
import { PlusCircle, GraduationCap, Edit, Calendar, User, DatabaseBackup } from 'lucide-react';
...
export default function TreinamentosPage() {
  ...
  const fetchTreinamentos = async () => {
    ...
    try {
      ...
      addToast((error as any)?.message || 'Erro ao carregar treinamentos.', 'error');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleEdit = async (id: string) => {
    ...
    try {
      ...
      addToast((error as any)?.message || 'Erro ao carregar treinamento.', 'error');
      setIsFormOpen(false);
    } finally {
  ...
  return (
    <div className="p-1 space-y-6">
      <PageHeader
        ...
        description="Gestão de capacitação e eficácia (ISO 9001: 7.2)."
